...
public class OrdenController implements Initializable {
    ...
    private void actualizar(ActionEvent event) {
        ...
        for (Orden o : Sesion.ordenes) {
                if (Integer.parseInt(txtId.getText()) == o.getId()) {
                    posicion = Sesion.ordenes.indexOf(o);
                    break;
                }
            }
            orden.setId(Integer.parseInt(txtId.getText()));
            Sesion.ordenes.set(posicion, orden);
            Orden.sigIdOrden --;
    ...
    private void eliminar(ActionEvent event) {
         ...
         try {
            ...
            Sesion.ordenes.remove(posicion);
    ...
    public ObservableList<Orden> getOrdenes() {
        ...
        for (Orden orden : Sesion.ordenes) {
